...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserSetting = getSharedPreferences("user",  Context.MODE_PRIVATE);
        editor = mUserSetting.edit();
        ...
        Button mContinueForTestButton = (Button) findViewById(R.id.continue_for_test_button);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private String mResponseEmail = "xxxx@xxx.com";
        private String mResponsePwd = "xxx";

        UserLoginTask(String email, String password) {
            mEmail = email;
            System.out.println("Input email : " + mEmail);
            mPassword = password;
            System.out.println("Input password : " + mPassword);
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("http://121.40.128.16/api/login".trim());
                ...
                if (responseCode ==  200) {
                    ...
                    mResponseEmail = jsonObj.getString("email");
                    mResponsePwd = jsonObj.getString("password");


                    mEapp.setSignedIn(false);
                    mEapp.setDeviceId(jsonObj.getString("deviceId"));
                    mEapp.setEmail(mResponseEmail);
                    mEapp.setUserId(jsonObj.getString("id"));
                    mEapp.setDeviceSim(jsonObj.getString("deviceSim"));
                    mEapp.setName(jsonObj.getString("name"));
                    ...
                    System.out.println("get password : " + jsonObj.getString("password"));
                } else {
                    mResponseEmail = "xxx@xxx.com";
                    mResponsePwd = "xxxx";
                }
            ...
            if (mResponseEmail.equals(mEmail)) {
                // Account exists, return true if the password matches.
                System.out.println("Good!");
                if (mResponsePwd.equals(mPassword)) {
                    mEapp.setSignedIn(true);
